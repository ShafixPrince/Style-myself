...
public class DatabaseMangerHeadwear extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "StyleMyself";
    private static final int DATABASE_VERSION = 1;
    private static final String TABLE_NAME = "Headwear";
    private static final String COLUMN_ID = "id";
    private static final String COLUMN_NAME = "name";
    private static final String COLUMN_COLOR = "color";
    private static final String COLUMN_TYPE= "type";
    private static final String COLUMNN_URL="link";


    DatabaseMangerHeadwear(Context context) {
    ...
    boolean insertProfileData(String name, String address, String password) {
        ...
        contentValues.put(COLUMN_COLOR, address);
        contentValues.put(COLUMN_TYPE, password);
